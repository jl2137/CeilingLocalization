...
## Core Architecture
* **Frontend:** Glassmorphism UI built with HTML5/CSS3/Vanilla JS (No heavy frameworks).
...
1. Install dependencies: `pip install fastapi uvicorn opencv-python numpy`
2. Start the server: `uvicorn main:app --reload`
3. Open your browser and navigate to: `http://127.0.0.1:8000`

## Repository Structure
* `main.py` - FastAPI server and Reality Model logic
* `cv_pipeline.py` - ORB feature matching functions
* `/dataset` - Contains reference map images and test queries

---

## 🧪 Testing Scenarios (Reality Model Evaluation)
To evaluate how the Reality Model handles different spatial constraints, you can upload the sample images provided in the `/dataset/test_queries` directory in specific sequences. 
